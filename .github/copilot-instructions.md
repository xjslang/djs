...
- Copilot Chat must answer in **Spanish** unless explicitly asked otherwise.
- All code generated by Copilot must be written in **English**.
- All comments inside code examples must be written in **English**.
- Explanations, reasoning and summaries go in **Spanish**.
